...
public class App {
    ...
    public static void main(String[] args) {
        ...
        try {
            usuarioService.createUser("dbasto", "David Basto", "12345", "ADMIN");

            usuarioService.createUser("jcalvo", "Jimmi Calvo", "12345", "CLIENTE");

            usuarioService.createUser("solave", "Sophia Olave", "12345", "ADMIN");
        } catch (Exception e) {
